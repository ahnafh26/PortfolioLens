...
FastAPI backend for PortfolioLens. Fetches price history, runs the risk/return/optimization math, backtests against real historical stress periods, computes rebalancing trades, generates AI-assisted portfolio insights, and exports PDF/CSV reports.
