// custom line-icon set, replacing lucide-react
...
export function IconBroadcast(props: IconProps) {
  return (
    <BaseIcon {...props}>
      <path d="M12 21a1 1 0 100-2 1 1 0 000 2z" fill="currentColor" stroke="none" />
      <path d="M8.3 15.3a5.2 5.2 0 017.4 0" />
      <path d="M5 12a9.8 9.8 0 0114 0" />
    </BaseIcon>
  );
}
...
// filled brand marks, not stroke-based like the rest of the set
